...
def SplitData(data,M,k,seed):
    test_set=codecs.open('/Users/xiaocong/Downloads/moviedata/testfile/test_set.txt','a','utf-8')
    train_set=codecs.open('/Users/xiaocong/Downloads/moviedata/testfile/train_set.txt','a','utf-8')
    random.seed(seed)
    for dat in data:
